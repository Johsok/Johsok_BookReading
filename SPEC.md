...
7. 書名切換後，依風格顯示左／右側欄、頂部書封、報刊、儀表板或長卷等版面；窄螢幕統一改為單欄，不顯示來源切換或點數按鈕。
8. 風格與背景選擇會寫入 `localStorage`。
9. 首頁直接進入書籍內容，不顯示大型標題與統計區。
10. 15 種風格必須改變欄位方向、資訊層級、卡片排列或閱讀動線，不得只有顏色差異；典藏書房風格的左欄在桌面捲動時維持螢幕垂直置中。
