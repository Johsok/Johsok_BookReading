...
import findbook_batch_20260717_b8 as previous


batch = previous.batch
FROM_DATE = "2026-06-18"
TO_DATE = "2026-07-17"
WORK_ID = "findbook-20260717-151327-b9"
CANDIDATE_PATH = Path(__file__).with_name(
    ".findbook_browser_candidates_20260717_b9.json"
)
...
batch.source_name = previous.previous.previous.source_name
batch.highlights_for = previous.previous.previous.highlights_for
