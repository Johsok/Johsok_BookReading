...
EXTRA_POOLS = {
    "01_business_startup": (
        ...
        ("領導前，先問鏡中的自己：哈佛商學院的高效領導課", "羅伯特．史蒂芬．凱普蘭", "2026-02-09", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("比特幣從頭學：比特幣投資家帶你看懂華爾街怎麼解讀比特幣", "安東尼．史卡拉穆奇", "2026-02-09", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("指數致富：普通人也能複製的長期致富法則", "周岐原", "2026-02-06", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("風險玩家：以川流思維戰勝風險的決策聖經", "奈特．席佛", "2026-02-06", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("賽局理論簡明讀本：為什麼高勝率策略會違反直覺？", "布萊恩．克雷格", "2026-02-05", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("1分鐘圖解賽局理論：掌握人性心理的55個博弈思維", "杜贏", "2026-02-05", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("三分鐘邏輯課：在AI時代培養思考力的8堂必修課", "蔣巍巍", "2026-02-05", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("大缺工時代的預防離職教科書：用心理學解決人力不足", "藤田耕司", "2026-02-05", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("當辦公室鴉雀無聲：用交疊溝通讓沉默變成對話", "高橋克徳", "2026-02-04", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("贏家思維：每天強大1%", "李勝隆", "2026-02-04", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("遊戲淘金攻略：50年商業模式大解密", "岩崎啟真", "2026-01-28", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("光速交易：超高速演算法如何改變金融市場？", "唐納・麥肯錫", "2026-01-28", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("馬斯克的X帝國：一場價值440億美元的推特權力遊戲", "寇特・華格納", "2026-01-27", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("策略長在生活裡：從日常生活到商業戰場", "施淑芳", "2026-01-27", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("財富自由心理學：療癒金錢焦慮，修練致富心態", "蔡宇哲、郝旭烈", "2026-01-27", "https://www.books.com.tw/web/sys_topme/books/02"),
        ("AI分散式領導：釋放每個人的內在CEO", "傑里米．布萊恩", "2026-03-09", "https://www.books.com.tw/web/sys_topme/books/02/?o=1&page=1&v=2"),
        ("穀倉效應：為什麼分工反而造成企業崩壞、政府無能、經濟失控？", "吉蓮．邰蒂", "2026-03-06", "https://www.books.com.tw/web/sys_topme/books/02/?o=1&page=1&v=2"),
    ),
    "02_psychology_growth": (
        ...
        ("中年後的我，不孤單也不委屈：32堂人際關係心理課", "李湖仙", "2026-03-05", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("寧夏璐陪你看世界：在人生最忙的時候，不要忘記了自己", "夏嘉璐、黃瑽寧", "2026-03-05", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("AI做不到的事：打造提問與思辨能力的親子哲學課", "苫野一德", "2026-03-04", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("鍵結效應：少數人的念力，可以改變多數人的生活", "琳恩．麥塔格特", "2026-03-03", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("學校不會教的人生課：怡慧老師的實踐成長學", "宋怡慧", "2026-03-02", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("人生是活給自己的，心煩意亂就留給別人", "宋曉東", "2026-02-25", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("我跟門薩學的用腦好習慣：聰明可以後天訓練", "中野信子", "2026-02-12", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("你的心值得好好安放：六祖壇經的輕禪練習", "費勇", "2026-02-11", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("不是別人不懂你，而是你不懂得愛自己", "叢非從", "2026-02-11", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("不知該努力或得過且過，那就在自己的花期前，活出想要的", "Eleven（いれぶん）", "2026-02-11", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("今天，你會有好事發生：願我們的好運，可以抵抗世間所有的堅硬", "序詩", "2026-02-11", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("以終為始的思考：日本百年塾100則處世智慧", "高野登", "2026-02-07", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("顧好自己就夠了：暖男身心科醫生教你35個立下界線的課題", "藤野智哉", "2026-02-04", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("擺脫無效親密：9堂教養心理課", "黃啟團", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("不擅長，也能閃閃發光：學會克服恥辱，而非隱藏脆弱", "凱倫．里納迪", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("不是妳想太多：給所有身心俱疲的新世代中年女性", "艾達．卡爾霍恩", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("溝通氣場：關鍵不是你說什麼，而是你看起來有沒有料", "麥可．查德．霍普納", "2026-02-02", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("找到你的甜蜜點：尋找人生隱藏機會的9種洞察力", "山姆．理查德", "2026-02-01", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("好好活著：不再受負面情緒綁架的14個練習", "約翰．辛德勒", "2026-02-01", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("回應的力量：讀懂人心的溝通顯化練習", "周震宇、馬可欣", "2026-02-01", "https://www.books.com.tw/web/sys_topme/books/07"),
        ("推理心理學：怎樣透過幻象看清真相", "阿爾弗雷德·比奈", "2025-12-17", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("內心強大 情緒穩定：不焦慮不抑鬱不內耗的心理學", "劉暢、程社明、魯晨慧", "2025-12-16", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("和好心情做室友：管理內心噪音，打造內心秩序", "索妮婭·溫格爾", "2025-12-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("壞信念：為什麼人們會相信那些不合理的謬論", "尼爾·利維", "2025-12-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("青春期心理養育", "宋立", "2025-10-24", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("當女兒決定不乖：告別好女兒綜合征", "凱瑟琳·法布里齊奧", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("隨他們去：擺脫控制欲、奪回能量的行動指南", "梅爾·羅賓斯、索耶·羅賓斯", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("1分鐘冥想", "馬丁·保羅森", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("向內生長：81個心理學概念讀懂自己", "顏妍、朱佳旭", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("刺蝟的距離：親密關係中的愛與傷", "德波拉·安娜·盧普尼茨", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("不要擔心2小時和8公里以外的事情", "李松濤", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("情緒之書", "翁貝托·加林伯蒂", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("我是倖存者嗎？", "金初瓏", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("不聽話的勇氣", "大鶴和江", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("氣候變化心理學", "傑弗里·貝蒂、勞拉·麥奎爾", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("情結", "河合隼雄", "2025-10-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("生活中的心理學智慧", "韋志中", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("偶爾出格：療愈自己的39種方式", "觀心實驗室", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("心流與積極心理學", "米哈里·契克森米哈伊", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("輕釋壓", "詹妮弗·L.泰茲", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("情緒敏捷的大腦：掌握驅動自我的12種情緒需求", "J.D.平卡斯", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("身體知道幸福：發現感恩、幸福與喜悅的意想不到的方式", "尼斯·卡普蘭", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("我給自己建了一座心靈補給站", "埃瑪·赫伯恩", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("慢慢變成大人", "芭芭拉·于貝爾、桑德拉·博西", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("心理學放映廳", "楊眉", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("停止自我攻擊", "周小寬", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("找回我自己", "薩拉·庫布里克", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
        ("迴避型依戀", "岡田尊司", "2025-09-01", "https://www.books.com.tw/web/sys_midme/china/0405"),
    ),
    "03_natural_science": (
        ...
        ("探索微觀星球，顯微鏡下的生活日常", "吳成軍", "2026-01-28", "https://www.books.com.tw/web/sys_topme/books/06"),
        ("先進儲能電池智慧製造技術與設備", "陽如坤", "2026-01-21", "https://www.books.com.tw/web/sys_topme/books/06"),
        ("與花方作譜，宋代植物譜錄循跡", "久保輝幸、羅桂環", "2026-01-07", "https://www.books.com.tw/web/sys_topme/books/06"),
        ("恆溫動物形貌史，鳥類和哺乳類的外觀演化", "亞歷山大．韋特摩爾、小格利特．S.米勒、詹姆斯．W.吉德利", "2026-01-07", "https://www.books.com.tw/web/sys_topme/books/06"),
        ("模式識別與機器學習", "克里斯托弗·M.畢曉普", "2025-12-30", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("寒區有機廢棄物厭氧發酵製備沼氣工藝", "孫勇等", "2025-12-23", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("節理岩體的非線性力學特性描述方法與應用", "李樹武、符文熹、劉高等", "2025-12-21", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("灘塗貝類養殖裝備與技術", "李秀辰、張國琛、母剛", "2025-12-20", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("合成生物系統調控與優化技術", "劉立明、高聰等", "2025-12-15", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("碳達峰規律和我國碳達峰行動方案研究", "董鋒、喬均、崔珏等", "2025-11-01", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("礦區土壤與大型場地污染控制及修復", "王聖瑞、范福強、董越", "2025-11-01", "https://www.books.com.tw/web/sys_pcbtopm/china/10"),
        ("圖解代數", "凱蒂·斯特克爾斯", "2025-07-01", "https://www.books.com.tw/web/sys_topme/china/10/?o=5&v=1"),
        ("二十四節氣百科全書", "宋英傑", "2025-07-01", "https://www.books.com.tw/web/sys_topme/china/10/?o=5&v=1"),
        ("牛津通識讀本：恆星", "安德魯·金", "2025-10-01", "https://www.books.com.tw/web/sys_topme/china/10/?o=5&v=1"),
    ),
    "04_healthcare": (
        ...
        ("讓我們一起好好慢慢變老：江守山醫師分享科學抗老實踐", "江守山", "2026-02-24", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("瑜伽動作序列設計：針對不同體質與週期編排瑜伽動作", "馬克．史蒂芬斯", "2026-02-12", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("運動營養學超入門", "岡村浩嗣", "2026-02-12", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("通氣血，排文明毒：從小毛病到心血管與免疫重症的中醫解方", "莊佳穎", "2026-02-04", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("代謝自由：30天有效燃脂、修復荷爾蒙、重建代謝平衡", "班．阿札迪", "2026-02-04", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("預約長壽，遇見長壽：實證長壽醫學的生活實踐", "鄭博仁", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("不只是感冒：耳鼻喉不適，潛藏的致命危機", "張智銘", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/08"),
        ("圖解藥物代謝動力學：看懂藥物在體內的旅程", "Kevin Chen", "2026-02-03", "https://www.books.com.tw/web/sys_topme/books/08"),
    ),
    "05_food_wellness": (
