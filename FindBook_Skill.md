...
2. ChatGPT提示詞需要求：書籍 100 個重點整理，每個重點格式必須是 `01、...` 到 `100、...`，不得引用大段原文，內容以高層次讀書筆記、核心觀念與可應用洞察為主，以繁體中文文字輸出，除了100個重點，其餘的文字都不要。
...
4. Gemini 提示詞需要求：出該書籍的 100 個重點整理，格式為 `01、...` 到 `100、...`，不得引用大段原文，內容以高層次讀書筆記、核心觀念與可應用洞察為主，以繁體中文文字輸出，除了100個重點，其餘的文字都不要。
