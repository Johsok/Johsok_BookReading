# -*- coding: utf-8 -*-
"""Overwrite chatgptHighlights for 07_other-20260717-41."""
...
SRC = ROOT / r"Books\07_other\07_other-20260717-41.json"
BODIES_PATH = ROOT / r"_tmp\hl_07_41_bodies.txt"
BANNED = ("本書", "作者指出", "本章", "這一章", "｜", "《")
TITLE_BITS = ("變臉的緬甸", "理查．考科特", "考科特", "Cockett")
...
def validate(bodies: list[str]) -> None:
    ...
    for i, b in enumerate(bodies, 1):
        ...
        if not re.match(r"^\d{3}、", f"{i:03d}、{b}"):
